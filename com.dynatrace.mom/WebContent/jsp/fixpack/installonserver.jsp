...
<html lang="en"><%
	...
	FixPack fixPack = fpm.getFixPack();
%>
	<head>
...
<jsp:include page="/jsp/tabs.jsp" />	
						...
						<div id="tab_incidents" class="ui-tabs-panel ui-widget-content ui-corner-bottom">
							...
							<div>Press <button>OK</button> to install <%= fixPack.getVersion() %> on these dynaTrace Servers</div><%
							...
							if (!Iterables.isNullOrEmpty(serverRecords)) { %>
								...
								for (ServerRecord serverRecord : serverRecords) { %>
									<tr>
										<td style="padding: 0px; width: 32px; height: 32px; border-bottom: 1px solid black; background-image: url(${pageContext.request.contextPath}/images/chart-loader.gif); background-repeat: no-repeat; background-position: center center" width="50"><img width="32" height="32" src="${pageContext.request.contextPath}/images/server.png" /></td>
