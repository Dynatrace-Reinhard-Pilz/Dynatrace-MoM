...
public class StringsTest extends Coverage<Strings> {
	...
	public void testEquals() {
		...
		Assert.assertFalse(Strings.equals(UUID.randomUUID(), UUID.randomUUID()));
	...
	public void testJoin() {
		...
		Assert.assertEquals(0, Strings.join("", (Object[]) null).length());
		Assert.assertEquals(0, Strings.join(",").length());
		Assert.assertEquals(0, Strings.join(null, new Object[] { null }).length());
		Assert.assertEquals(0, Strings.join(",", new Object[0]).length());
		Assert.assertEquals(0, Strings.join(",", new Object[] { null }).length());
		...
		Assert.assertEquals("x", Strings.join(",", new Object[] { null, "x", null }));
	}
	...
	public void testUrlEncode() {
		try {
			Assert.assertEquals(Strings.EMPTY, urlEncode(null, UUID.randomUUID().toString()));
			Assert.assertEquals(Strings.EMPTY, urlEncode(Strings.EMPTY, Strings.UTF8));
			Assert.assertEquals(Strings.PLUS, urlEncode(Strings.SPC, Strings.UTF8));
			String s = UUID.randomUUID().toString();
	...
	public void testToString() {
		...
		Assert.assertEquals(StringsTest.class.getSimpleName(), Strings.toString(this));
		Assert.assertEquals(StringsTest.class.getSimpleName(), Strings.toString(this, (Object[]) null));
		Assert.assertEquals(StringsTest.class.getSimpleName(), Strings.toString(this, new Object[0]));
		Assert.assertEquals(StringsTest.class.getSimpleName() + "[a, b]", Strings.toString(this, "a", null, "b"));
		Assert.assertEquals(StringsTest.class.getSimpleName(), Strings.toString(this, null, null, null));
	}
