...
public final class Measure {
	...
	private int count = 0;
	private Collection<Measurement> measurements = null;
	...
	public final void setAggregation(final String aggregation) {
	...
	public final void setMeasurements(final Collection<Measurement> measurements) {
		this.measurements = measurements;
	}
	
	@XmlElementRef(type = Measurement.class)
